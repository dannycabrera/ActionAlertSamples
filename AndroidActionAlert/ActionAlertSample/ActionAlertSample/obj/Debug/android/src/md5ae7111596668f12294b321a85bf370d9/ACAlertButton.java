...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ActionComponents.ACAlertButton, ActionComponents, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ACAlertButton.class, __md_methods);
	}


	public ACAlertButton (android.content.Context p0)
	{
		super (p0);
		if (getClass () == ACAlertButton.class)
			mono.android.TypeManager.Activate ("ActionComponents.ACAlertButton, ActionComponents, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}


	public ACAlertButton (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == ACAlertButton.class)
			mono.android.TypeManager.Activate ("ActionComponents.ACAlertButton, ActionComponents, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0, p1 });
	}


	public ACAlertButton (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == ACAlertButton.class)
	...
	public ACAlertButton (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3)
	{
		super (p0, p1, p2, p3);
		if (getClass () == ACAlertButton.class)
